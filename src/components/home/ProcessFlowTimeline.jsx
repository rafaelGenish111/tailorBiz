...
const steps = [
  ...
  },
  {
    ...
    details: 'האוטומציות והבנדל על כל שלב שיוטע ואפיין יורד לצרכים, נסמוך על לייצר שוטף ומדי פעם ניתן לכם תצוגה מבינינים לפרויקט.',
  ...
  },
  {
    ...
    details: 'בנוני לפני שנשלים לאוור ורג\'יס סיסטם כדי לוודא שכל עובד פיקס וכל החיבורים והאוטומציות רצים כמו שצריך ומתוכננים לעשיה לאוויר.',
